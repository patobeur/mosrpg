	...
	playerManager() {
		let player = {
			...
			datas: {
				...
				stats: {
					strength: this.communsTools.get_aleaEntreBornes(10, 16),// new Number('10'),
					agility: this.communsTools.get_aleaEntreBornes(10, 16),// new Number('10'),
					karma: this.communsTools.get_aleaEntreBornes(10, 16),// new Number('10'),
					intelect: this.communsTools.get_aleaEntreBornes(10, 16),// new Number('10'),
					dexterity: this.communsTools.get_aleaEntreBornes(10, 16),// new Number('10'),
					wisdom: this.communsTools.get_aleaEntreBornes(10, 16),// new Number('10'),
					fortitude: this.communsTools.get_aleaEntreBornes(10, 16),// new Number('10'),
				},
				scale: new Number('1'),
